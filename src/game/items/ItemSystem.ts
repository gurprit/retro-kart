...
const BATTLE_COURSE_ITEM_BOXES = [
  {id:'bc1-01',xRatio:.50,yRatio:.15},{id:'bc1-02',xRatio:.42,yRatio:.20},{id:'bc1-03',xRatio:.58,yRatio:.20},
  {id:'bc1-04',xRatio:.25,yRatio:.30},{id:'bc1-05',xRatio:.50,yRatio:.29},{id:'bc1-06',xRatio:.75,yRatio:.30},
  {id:'bc1-07',xRatio:.34,yRatio:.39},{id:'bc1-08',xRatio:.50,yRatio:.39},{id:'bc1-09',xRatio:.66,yRatio:.39},
  {id:'bc1-10',xRatio:.20,yRatio:.49},{id:'bc1-11',xRatio:.40,yRatio:.49},{id:'bc1-12',xRatio:.60,yRatio:.49},{id:'bc1-13',xRatio:.80,yRatio:.49},
  {id:'bc1-14',xRatio:.30,yRatio:.58},{id:'bc1-15',xRatio:.50,yRatio:.58},{id:'bc1-16',xRatio:.70,yRatio:.58},
  {id:'bc1-17',xRatio:.22,yRatio:.68},{id:'bc1-18',xRatio:.40,yRatio:.68},{id:'bc1-19',xRatio:.60,yRatio:.68},{id:'bc1-20',xRatio:.78,yRatio:.68},
  {id:'bc1-21',xRatio:.32,yRatio:.78},{id:'bc1-22',xRatio:.50,yRatio:.78},{id:'bc1-23',xRatio:.68,yRatio:.78},
  {id:'bc1-24',xRatio:.50,yRatio:.88},
] as const
const BATTLE_COURSE_TRACK_COINS = [
  {xRatio:.34,yRatio:.14},{xRatio:.43,yRatio:.14},{xRatio:.57,yRatio:.14},{xRatio:.66,yRatio:.14},
  {xRatio:.18,yRatio:.23},{xRatio:.29,yRatio:.23},{xRatio:.40,yRatio:.23},{xRatio:.60,yRatio:.23},{xRatio:.71,yRatio:.23},{xRatio:.82,yRatio:.23},
  {xRatio:.14,yRatio:.34},{xRatio:.27,yRatio:.34},{xRatio:.42,yRatio:.34},{xRatio:.58,yRatio:.34},{xRatio:.73,yRatio:.34},{xRatio:.86,yRatio:.34},
  {xRatio:.12,yRatio:.45},{xRatio:.23,yRatio:.45},{xRatio:.37,yRatio:.45},{xRatio:.50,yRatio:.45},{xRatio:.63,yRatio:.45},{xRatio:.77,yRatio:.45},{xRatio:.88,yRatio:.45},
  {xRatio:.12,yRatio:.56},{xRatio:.24,yRatio:.56},{xRatio:.38,yRatio:.56},{xRatio:.50,yRatio:.56},{xRatio:.62,yRatio:.56},{xRatio:.76,yRatio:.56},{xRatio:.88,yRatio:.56},
  {xRatio:.14,yRatio:.66},{xRatio:.27,yRatio:.66},{xRatio:.42,yRatio:.66},{xRatio:.58,yRatio:.66},{xRatio:.73,yRatio:.66},{xRatio:.86,yRatio:.66},
  {xRatio:.18,yRatio:.77},{xRatio:.30,yRatio:.77},{xRatio:.42,yRatio:.77},{xRatio:.58,yRatio:.77},{xRatio:.70,yRatio:.77},{xRatio:.82,yRatio:.77},
  {xRatio:.34,yRatio:.87},{xRatio:.43,yRatio:.87},{xRatio:.57,yRatio:.87},{xRatio:.66,yRatio:.87},
] as const
...
export class ItemSystem {
  ...
  private spawnTrackCoins(){if(this.networkAuthority)return;for(const d of BATTLE_COURSE_TRACK_COINS)this.spawnWorldItem('coin','track',this.renderer.sourceWidth*d.xRatio,this.renderer.sourceHeight*d.yRatio,0,0,Infinity,0,true)}
