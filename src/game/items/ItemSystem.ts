...
const MARIO_CIRCUIT_ITEM_BOXES = [{id:'mc1-1',xRatio:.83,yRatio:.5},{id:'mc1-2',xRatio:.87,yRatio:.5},{id:'mc1-3',xRatio:.91,yRatio:.5},{id:'mc1-4',xRatio:.95,yRatio:.5},{id:'mc1-5',xRatio:.99,yRatio:.5}] as const
const MARIO_CIRCUIT_TRACK_COINS = [{xRatio:.91,yRatio:.61},{xRatio:.91,yRatio:.57},{xRatio:.89,yRatio:.53},{xRatio:.78,yRatio:.49},{xRatio:.66,yRatio:.45},{xRatio:.53,yRatio:.42},{xRatio:.4,yRatio:.46},{xRatio:.31,yRatio:.56},{xRatio:.42,yRatio:.67},{xRatio:.64,yRatio:.68}] as const
...
export class ItemSystem {
  ...
  private spawnTrackCoins(){if(this.networkAuthority)return;for(const d of MARIO_CIRCUIT_TRACK_COINS)this.spawnWorldItem('coin','track',this.renderer.sourceWidth*d.xRatio,this.renderer.sourceHeight*d.yRatio,0,0,Infinity,0,true)}
